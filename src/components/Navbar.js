                        ...
                        <div className="row">
                            <div className="col-xl-12">
                                <p>This handy little bar is great for informing visitors of various features. <a
                                        href="#" className="btn2">Learn More</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="header-bottom  header-sticky">
                <div className="container-fluid">
                    <div className="d-flex align-items-center justify-content-between flex-wrap position-relative">
                        ...
                        <div className="logo">
                            <a href="index.html" className='logocss'>CAMPUS HEALTH HUB</a>
                        </div>
                        ...
                        <button type="submit" className='btn_1 d-none d-xl-block'>Register</button>
